...
async function firmarSemana(semanaNumero, anio, idAlumno) {
    ...
    image.src = firma.docs[0].data().FirmaTutor;
}
        ...
        .then((base64Data) => {
            ...
            .then((querySnapshot) => {
                ...
                if (querySnapshot.docs.length > 0) {
                    ...
                    actualizarFirmaTutor(querySnapshot.docs[0].id, base64Data);
                } else {
                    // Guardar la firma en Firestore
                    guardarNuevaFirmaTutor(idAlumno, base64Data, semanaNumero, anio);
                }
            });
        });
    });
...
function guardarNuevaFirmaTutor(idAlumno, base64Data, semanaNumero, anio) {
    db.collection("Firma").add({
        id_Usuario: idAlumno,
        FirmaTutor: base64Data,
...
function actualizarFirmaTutor(idFirma, base64Data) {
